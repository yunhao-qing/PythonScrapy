...
class getProxy():
    ...
    def check_webs(self):
        ...
        print(len(raw_ips))
        self.iphai()
        self.loop_xici(1, 5) #20
        self.loop_xici2(1, 5)  # 20
        self.loop_nianshao(1,3) #20
        self.loop_ip66(1,5) #200
        self.loop_xsdaili(1,5) #62
        self.loop_ip181(1, 5) #882
        self.ipyqle()
        self.loop_ip3366(1, 5)
        #self.loop_proxydb(1, 5) #91 这个网页格式不规范 有时候会出问题
        #self.loop_dlip(2,8)
