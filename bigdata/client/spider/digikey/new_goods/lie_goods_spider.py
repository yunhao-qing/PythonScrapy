...
class LieGoodsSpider(Spider):
    ...
    def __init__(self, cat_id, goods_sn, url, pdf_url,goods_thumb,ch,routingkey):
    ...
    def rule_img_left(self, html):
        ...
        try:
            if pd is None:
                ...
                with open('./那种没有图片梯度的数据.txt', 'a') as f:
                    logstr = dict(
                        time_ = time.ctime(),
                        cat_id=self.cat_id,
    ...
    def update_goods_mysql(self, goods_name, zzs, goods_img, goods_desc,
        ...
        lg['site_url'] = self.url
        lg['pdf_url'] = self.pdf_url
        lg['goods_sn'] = self.goods_sn
        ...
        lg['goods_id'] = -1
        lg['goods_thumb'] = self.goods_thumb
...
if __name__ == '__main__':
    ...
    url = 'http://www.digikey.cn/product-detail/zh/vishay-dale/RWR78S1960FSRSL/RWR78S1960FSRSL-ND/3275911'
    cat_id = 1
    goods_id = 1
    goods_sn = '1'
    is_first = False
