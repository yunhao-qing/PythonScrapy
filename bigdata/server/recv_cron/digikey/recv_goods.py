...
def main():
    global DIGIKEY_STORE_GOODS, RBMQ
    ...
    channel.queue_declare(queue=DIGIKEY_STORE_GOODS, durable=True)
    channel.basic_consume(callback, queue=DIGIKEY_STORE_GOODS, no_ack=False)
    print('waiting store goods task')
